...
function makeDeps(overrides: Partial<CommandDeps> = {}): CommandDeps {
  const actionNames = [
    ...
    'copyActive', 'extractSelection', 'splitHere', 'splitByHeading', 'autoTagActive', 'promoteToType',
...
describe('buildCommandRegistry', () => {
  it('returns the full command set with stable ids', () => {
    ...
    expect(ids).toEqual([
      ...
      'refactor.autoTag', 'objects.promoteToType', 'refactor.autoLink', 'refactor.autoLinkInbound',
  ...
  it('dispatches each command run() to its corresponding dependency', () => {
    ...
    const wiring: Record<string, keyof CommandDeps> = {
      ...
      'refactor.splitByHeading': 'splitByHeading', 'refactor.autoTag': 'autoTagActive', 'objects.promoteToType': 'promoteToType',
