...
// URI helpers live in ./state — the leaf module shared by the indexers here and
// the read/query layer in ./queries. Imported here; not re-exported (external
// callers use the public read/write API, not GraphState internals).
import {
