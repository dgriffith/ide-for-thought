...
import { parseMarkdown, type FrontmatterValue, type FrontmatterMap } from './parser';
...
import {
  ...
  MINERVA, DC, RDF, XSD, BIBO, SCHEMA, PROV, THOUGHT, TYPES,
  noteUri, tagUri, folderUri, sourceUri, projectUri,
